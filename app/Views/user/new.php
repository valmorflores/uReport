<div class="hero fullscreen">
    <div class="hero-body">
        <div style="margin: auto">
            <form class="frame p-0" action="<?php echo base_url();?>/public/user/post" method="post">
                <div class="frame__body p-0">
                    <div class="row p-0 level fill-height">
                            ...
                            <div class="col">
                                ...
                                <div class="padded">
                                    <h1 class="u-text-center u-font-alt">Novo usuário</h1>
                                    ...
                                    <div class="form-section section-inline">
                                        <div class="section-body row">                                                
                                            <div class="form-group col-6 pl-0">
                                                ...
                                                <input type="date" name="nascimento" id="nascimento" class="form-group-input" placeholder="Nascimento" />
                                            </div>
                                        </div>
                                    </div>
