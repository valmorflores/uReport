            ...
            <div class="hero-body">
               <div class="content">
                  <div class="text-center">
                     <h1>Validação</h1>
                     <p>A seguir você verá a lista de critério para validar o seu requerimento, caso algum item esteja faltando, edite para corrigir.</p>
					 <div class="form-section u-text-left">
                        ...
                        <P class="u-right"><form action="<?php echo base_url();?>/public/userrequirement/validateById/<?php echo $id;?>">
						<a href="<?php echo base_url();?>/public/userrequirement/edit/<?php echo $id;?>">Editar</a>			    
